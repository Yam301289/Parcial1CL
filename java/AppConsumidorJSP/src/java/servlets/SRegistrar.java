...
public class SRegistrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        registrar(ci, pass, apellidos, nombres, privilegio);
    }
    ...
    private String registrar(java.lang.String ci, java.lang.String pass, java.lang.String apellidos, java.lang.String nombres, java.lang.String privilegio) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        webservices.WSGestionUsuario port = service.getWSGestionUsuarioPort();
        return port.registrar(ci, pass, apellidos, nombres, privilegio);
    }
