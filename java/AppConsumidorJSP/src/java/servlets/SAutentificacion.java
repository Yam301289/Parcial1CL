...
public class SAutentificacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Empleado empleado = validar(ci, pass, privilegio);
        if(empleado!= null){
    ...
    private Empleado validar(java.lang.String ci, java.lang.String pass, java.lang.String privilegio) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        webservices.WSGestionUsuario port = service.getWSGestionUsuarioPort();
        return port.validar(ci, pass, privilegio);
    }
